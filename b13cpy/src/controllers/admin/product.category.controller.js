...
const {
  ...
  updateItem,
  getStatusCounts,
} = require("../../services/categoryProduct.service");
...
class NewsController {
  ...
  getAll = async (req, res, next) => {
    ...
    res.render("admin/product/category", { data, statusfilter: this.getStatusFilter(statusCounts, status), keyword, linkprefix });
};
  ...
  getForm = async (req, res, next) => {
    ...
    if (id == "") {
      ...
      res.render("admin/product/category/form", { data });
    }
  };
